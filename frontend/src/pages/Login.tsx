...
import { Zap, Lock, Mail, User as UserIcon, ArrowRight, ShieldCheck, CheckCircle, UserPlus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex bg-slate-900/90 p-1 rounded-xl border border-slate-800 mb-4 text-xs font-semibold">
          <button
            type="button"
        ...
        <div className="glass-card rounded-2xl p-8 border border-slate-800 shadow-2xl">
          <h2 className="text-xl font-bold text-white mb-6">
            {isSignUp ? 'Create Agent Credentials' : 'Agent Sign In'}
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required={isSignUp}
                    placeholder="e.g. Meghanadh (Sales Lead)"
            ...
            >
              {loading ? (
                ...
                <>
                  <span>{isSignUp ? 'Create Account & Sign In' : 'Sign In to Co-Pilot'}</span>
